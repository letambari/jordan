<div class="footer section-space100">
                ...
                <div class="row ">
                    ...
                    <div class="col-xl-7 col-lg-7 col-md-7 col-sm-12 col-12 ">
                        <div class="newsletter-form ">
                            <!-- Newsletter Form -->
                            <form action="http://jituchauhan.com/borrow/borrow/newsletter.php" method="post">
        ...
        <div class="row ">
            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 ">
                <div class="widget-text mt40 ">
                    <!-- widget text -->
                    <p>We’ve built our business around helping clients to trade and we’re delighted that our efforts have been recognised with over 25 awards since 2014.</p>
                    <div class="row ">
    ...
    <div class="tiny-footer">
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6">
                    <p>© Copyright 2020 | JORDAN & CO LIMITED</p>
                </div>
...
<!-- Mirrored from jituchauhan.com/borrow/borrow/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 Mar 2021 03:53:50 GMT -->
</html>