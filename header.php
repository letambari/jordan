...
<!-- Mirrored from jituchauhan.com/borrow/borrow/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 Mar 2021 03:52:18 GMT -->
<head>
    <meta charset="utf-8">
...
<body>
    <div class="sticky-top">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-4 col-lg-5 col-md-4 col-sm-6 col-6 d-none d-xl-block d-lg-block">
                        <p class="mail-text">Welcome to JORDAN & CO LIMITED</p>
                    </div>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-white py-3">
            <div class="container">
                <a href="index-2.html" class="navbar-brand"><img src="images/borrow-loan-logo.svg" alt="Borrow - Loan Company Website Template"></a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item">
                            <a class="nav-link" id="navbarHome" data-toggle="dropdown" href="index.php" aria-haspopup="true" aria-expanded="false">
                                Home
                            </a>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="navbarHome" href="about.php" aria-haspopup="true" aria-expanded="false">
                                About
                            </a>
                        ...
                        <li class="nav-item dropdown ">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarProduct">
                              <li class="dropdown-item dropright">
                                        <a class="dropdown-link" href="forex.php">
                                            Forex Trading
                                        </a>
                                        
                                    </li>
                                    <li class="dropdown-item dropright">
                                        <a class="dropdown-link " href="cryptocurrency.php">
                                    ...
                                    <li class="dropdown-item dropright">
                                        <a class="dropdown-link" href="stocks.php">
                                            Stocks & Commodities
                                        </a>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="packages.php" aria-haspopup="true" aria-expanded="false">
                                Packages
                            </a>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="faq.php" aria-haspopup="true" aria-expanded="false">
                                FAQ
                            </a>
                        ...
                        <!-- <li class="nav-item">
                            <a class="nav-link" id="navbarHome" data-toggle="dropdown" href="" aria-haspopup="true" aria-expanded="false">
                                Account
                            </a>
